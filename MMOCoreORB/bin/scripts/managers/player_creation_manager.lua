...
professionSpecificItems = {
	combat_brawler = { brawlerOneHander, brawlerTwoHander, brawlerPolearm, marksmanPistol, marksmanCarbine, marksmanRifle },
	combat_marksman = { marksmanPistol, marksmanCarbine, marksmanRifle, brawlerOneHander, brawlerTwoHander, brawlerPolearm },
	crafting_artisan = { genericTool, mineralTool, chemicalTool, foodTool },
	jedi = { },
